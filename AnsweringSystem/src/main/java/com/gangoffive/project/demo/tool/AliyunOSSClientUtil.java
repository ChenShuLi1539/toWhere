...
public class AliyunOSSClientUtil {
    ...
    //log日志
    protected static final Logger logger = LoggerFactory.getLogger(AliyunOSSClientUtil.class);
    //阿里云API的内或外网域名
    private static String ENDPOINT="oss-cn-beijing.aliyuncs.com";
    //阿里云API的密钥Access Key ID
    private static String ACCESS_KEY_ID="LTAI4GFoNN3ZAHUK3go7nGff";
    //阿里云API的密钥Access Key Secret
    private static String ACCESS_KEY_SECRET="CrdmfPDPztpEItsSGyJKRy72H7Wspl";
    //阿里云API的bucket名称
    private static String BACKET_NAME="langwenjun";
    //阿里云API的文件夹名称
    private static String FOLDER="gangoffive/video/";
